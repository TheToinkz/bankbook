<?php
	...
	if(!isset($_SESSION['username'])) {
		header('Location: ITMC231_Banday_login.php');
	}
	...
	//edit user info
	if(isset($_POST['edit'])) {
		header('Location: ITMC231_Banday_edit.php');
	}
	//check past transactions
	if(isset($_POST['history'])) {
		header('Location: ITMC231_Banday_history.php');
	}
	...
	if(isset($_POST['calc_intrst'])) {
		header('Location: ITMC231_Banday_calc.php');
	}
...
<html>
	<head>
		<title>MyBankNote Home</title>
		<link rel="stylesheet" type="text/css" href="ITMC231_Banday_banknote.css">
		<script>
	...
	<body>
		<form method = "post" action = "" class = "navbar">
			<img src="b.png" class = "logo" alt="MyBankNote">
