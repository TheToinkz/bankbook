<?php
	...
	if(isset($_POST['s_signup'])) { 
		...
		$u_pass = $_POST['s_password'];
		$u_confpass = $_POST['conf_password'];
		...
		if($s_username != "" && is_string($s_username) && $s_password != "" && is_string($s_password) && $u_pass == $u_confpass && $curr_bal != "" && is_numeric($curr_bal) && $int_rate != "" && is_numeric($int_rate) && $min_amnt != "" && is_numeric($min_amnt) && $increase != "" && is_string($increase) && $date != "" ) {
